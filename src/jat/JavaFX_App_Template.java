...
import chatroom.testClient.TestClient;
import jat.appClasses.App_Controller;
import jat.appClasses.App_Model;
import jat.appClasses.App_View;
import jat.appClasses.Chatroom_Controller;
import jat.appClasses.Chatroom_View;
import jat.splashScreen.Splash_Controller;
import jat.splashScreen.Splash_Model;
import jat.splashScreen.Splash_View;
...
public class JavaFX_App_Template extends Application {
    ...
    public void startApp() {
        ...
        new App_Controller(this, model, view);
    ...
    // Creates Chatroom GUI and showes it
    public void startChatroom(String chatroom) {
    	Stage chatStage = new Stage();
    	Chatroom_View chatroomView = new Chatroom_View(chatStage, model);
    	new Chatroom_Controller(model, chatroomView);
    	chatroomView.start(chatroom);
    }
